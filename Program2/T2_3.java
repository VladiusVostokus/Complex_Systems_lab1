public class T2_3 extends Thread {
    private int h;
    private Ops2 O;
    private int id;

    public T2_3(Ops2 o1, int n, int p, int threadId) {
        h = n / p;
        O = o1;
        id = threadId;
    }
    ...
    public void run() {
        ...
        try {
            O.data.sem4_3.acquire();
        } catch(InterruptedException e) {
            e.printStackTrace();
        }

        O.mergeVec(O.data.X1, 2, O.data.H * 3, O.data.H *  4);
        O.data.sem3_1.release();
